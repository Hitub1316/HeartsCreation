...
export default function BuyButton({ title, price, image, slug, available }: BuyButtonProps) {
  ...
  return (
    <button 
      ...
      className={`w-full py-5 text-xs uppercase tracking-[0.3em] font-medium transition-all duration-700 shadow-xl shadow-charcoal/10 mb-6 ${
        available && !loading
          ? "bg-charcoal text-cream hover:bg-wine cursor-pointer" 
